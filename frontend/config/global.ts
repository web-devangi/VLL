...
// global.ts
 ...
 // Renamed BASE_URL to API_BASE_URL+
export const API_KEY = '31c509e78c69b9bad8d47b78a0d45fe6';

export const API_BASE_URL = 'http://167.71.41.205';
export const API_ROUTES = {
  GET_PRODUCTS: '/pimcore-graphql-webservices/GetProduct', // Example route for fetching products
};
